...
function FuncExample(props) {
  const [motto, setMotto] = useState("");
  const [name, setName] = useState(window.lab1models.exampleModel().name)

  const handleChangeMotto = (event) => {
    setMotto(event.target.value);
  }//this.handleMotto(event);  
...
/*class Example extends React.Component {
  constructor(props) {
    ...
    // variable 'name'.
    this.state = {
      name: window.lab1models.exampleModel().name,
      counter: 0,
      inputValue: "",
      buttonWasClicked: "",
