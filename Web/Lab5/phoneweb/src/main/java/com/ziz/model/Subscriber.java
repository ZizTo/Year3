...
@NamedQuery(
    name = "Subscriber.findServicesBySubscriberId",
    query = "SELECT s FROM Subscriber sub JOIN sub.services s WHERE sub.id = :subscriberId"
)
public class Subscriber {
    ...
    @ManyToMany(fetch = FetchType.EAGER) // EAGER - load with anoth
    @JoinTable(
